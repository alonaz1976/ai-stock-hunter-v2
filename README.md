...
## V6.1.2 Feedback Export Hotfix
- Feedback Excel export is now always visible, even before the first 1D/2D/3D/5D outcome has matured.
- Workbook includes Snapshots, Outcomes, Pending Summary, Merged Audit, Stage Summary, Recent Weighted Summary and Recent Feature Lift.
- When no evaluated outcomes exist yet, the export still contains the collected live snapshots and pending-window counts.
