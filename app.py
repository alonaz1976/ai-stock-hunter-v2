...
APP_VERSION = "6.2.2"
APP_BUILD_ID = "V622-MATCHED-BASELINE-EVIDENCE-20260919-A"
...
st.markdown(f"""<div class='hero'><span class='badge'>V{APP_VERSION} • MATCHED BASELINE • EVIDENCE AUDIT • NO-OVERFIT GUARD</span><div class='hero-title'>📈 AI Stock Hunter<br>V{APP_VERSION}</div><div class='hero-sub'>Adaptive Entry Intelligence • Matched Opening Baseline • Causal Continuation Validation • OOS Evidence</div></div>""",unsafe_allow_html=True)
