...
APP_VERSION = "6.3.9.5"
APP_BUILD_ID = "V6395-COMPACT-TOP5-MOBILE-20260922-A"
...
def scanner_excel_bytes(df,scan_meta=None):
    ...
    with pd.ExcelWriter(bio,engine="openpyxl") as writer:
        ...
        di_cols=[c for c in ['Ticker','Market','Sector','TradePriorityRank','TopScore','OpportunityScore','TradeStage','EntryTriggerState','MoneyFlowScore','MoneyFlowLabel','MoneyFlowEvidence','MarketCycleScore','MarketCycleStage','MarketCycleReason','CatalystScore','CatalystLabel','CatalystEvidence','CatalystTopHeadline','CatalystRecentNewsCount','CatalystEventRisk','CatalystCoverage','EntryScore','LiveActionabilityScore','HourlyConfirm','MoveConsumedBeforeTriggerPct','ChaseRiskScore','ChaseRiskLabel','LiveRR_T1','LiveRR_T2','ExitPressure','ExitStage'] if c in out_df.columns]
...
with tab_scan:
    ...
    st.caption("Decision Intelligence: Money Flow + Market Cycle are computed for every analyzed stock; Catalyst is fetched for top candidates. Valuation, Regular Radar and Pre-Move remain research layers. None bypasses live risk/timing gates.")
