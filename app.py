...
def _ensure_decision_ranking_v63919(df, scan_mode='Production 151'):
    ...
    the Scanner is rerun under V6.3.9.22.
    """
    if df is None or not isinstance(df,pd.DataFrame) or df.empty:return df
    z=df.copy()
...
with tab_analyze:
    ...
    if snap and snap.get('payload'):
        ...
        st.markdown("<div class='top5-grid'>"+f"<div class='top5-mini'><span class='lbl'>Setup</span><span class='val'>{_an_setup:.0f}/100</span><span class='sub'>setup strength</span></div>"+f"<div class='top5-mini'><span class='lbl'>Entry</span><span class='val'>{_an_entry_score:.0f}/100</span><span class='sub'>Gates {int(ent.get('confirmed_conditions',0) or 0)}/{int(ent.get('total_conditions',6) or 6)}</span></div>"+f"<div class='top5-mini'><span class='lbl'>Hourly</span><span class='val'>{_an_hour_txt}</span><span class='sub'>timing</span></div>"+f"<div class='top5-mini'><span class='lbl'>Inflow</span><span class='val {_an_in_cls}'>{_an_in:.0f}/100</span><span class='sub'>{_e6395(_an_inlab)}</span></div>"+f"<div class='top5-mini'><span class='lbl'>Outflow</span><span class='val {_an_out_cls}'>{_an_out:.0f}/100</span><span class='sub'>{_e6395(_an_outlab)}</span></div>"+f"<div class='top5-mini'><span class='lbl'>Net Flow</span><span class='val {_an_net_cls}'>{_an_net:+.0f}</span><span class='sub'>{_e6395(_an_netlab)}</span></div>"+f"<div class='top5-mini'><span class='lbl'>Consumed</span><span class='val {_an_cons_cls}'>{_an_cons_txt}</span><span class='sub {_an_cons_cls}'>{_an_timing}</span></div>"+f"<div class='top5-mini'><span class='lbl'>Chase</span><span class='val {_an_chase_cls}'>{_e6395(_an_chase)}</span><span class='sub'>{_an_cr:.0f}/100</span></div>"+f"<div class='top5-mini'><span class='lbl'>R:R</span><span class='val'>{_an_rr1_txt}</span><span class='sub'>{_an_rr2_txt}</span></div>"+f"<div class='top5-mini'><span class='lbl'>Evidence</span><span class='val'>{_an_evprog}</span><span class='sub'>{_e6395(_an_evq)}</span></div></div>",unsafe_allow_html=True)
