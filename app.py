...
APP_VERSION = "6.3.9.2"
APP_BUILD_ID = "V6391-FEEDBACK-LIVE-AUDIT-HOTFIX-20260922-A"
...
with tab_scan:
    ...
    show_mode=st.selectbox("Show",["ALL","REGULAR HIGH CONFIDENCE","REGULAR RADAR","STRONG PRE-MOVE CANDIDATE","PRE-MOVE CANDIDATE","CONFIRMED ENTRY","OPTIMIZED CONFIRMED","OPTIMIZED ARMED","ARMED","EXTENDED / RETEST","TOP OPPORTUNITIES","ACTIONABLE NOW","WATCHLIST"],key="show_v613")
    st.caption("Three layers: Regular market-specific radar = +2/+3/+5/+8% research, Pre-Move = +5%/3D research radar, Live Entry = current trade timing. Research evidence never bypasses live risk/timing gates.")
