...
APP_VERSION = "6.1.7"
APP_BUILD_ID = "V617-LIVE-RR-CARRYOVER-GUARD-20260919-A"
...
st.markdown(f"""<div class='hero'><span class='badge'>V{APP_VERSION} • LIVE R:R GUARD • OVERNIGHT EXTENSION MEMORY • CHASE GUARD</span><div class='hero-title'>📈 AI Stock Hunter<br>V{APP_VERSION}</div><div class='hero-sub'>Adaptive Entry Intelligence • Live Reward/Risk • Overnight Extension Memory • RR-Aware Retest • OOS Evidence</div></div>""",unsafe_allow_html=True)
