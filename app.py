...
APP_VERSION = "6.2.0"
APP_BUILD_ID = "V620-ROBUSTNESS-CONTINUATION-VALIDATION-20260919-A"
...
st.markdown(f"""<div class='hero'><span class='badge'>V{APP_VERSION} • ORIGIN ROBUSTNESS • CONTINUATION VALIDATION • NO-OVERFIT GUARD</span><div class='hero-title'>📈 AI Stock Hunter<br>V{APP_VERSION}</div><div class='hero-sub'>Adaptive Entry Intelligence • Causal Origin Robustness • Continuation Validation • Sample Uncertainty • OOS Evidence</div></div>""",unsafe_allow_html=True)
