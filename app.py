...
APP_VERSION = "6.1.5"
APP_BUILD_ID = "V615-AH-FALLBACK-EVIDENCE-GUARD-20260919-A"
...
st.markdown(f"""<div class='hero'><span class='badge'>V{APP_VERSION} • AH FALLBACK • TRIGGER AUDIT • CHASE GUARD • EVIDENCE GUARD</span><div class='hero-title'>📈 AI Stock Hunter<br>V{APP_VERSION}</div><div class='hero-sub'>Adaptive Entry Intelligence • Session-Aware Pricing • Trigger Audit • Retest Planning • OOS Evidence</div></div>""",unsafe_allow_html=True)
