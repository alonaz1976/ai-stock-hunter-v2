...
APP_VERSION = "6.3.9.9"
APP_BUILD_ID = "V6399-PRICE-BESIDE-RANK-20260922-A"
    ...
    if res is None or res.empty:
        ...
        for _,r in topcards.iterrows():
            ...
            with st.container(border=True):
                ...
                _px=_num6395(r.get('Price',np.nan))
                ...
                st.markdown(f"<div class='top5-rankline'><b>TOP {top_score:.1f}</b> • <b>OPP {opp_score:.1f}</b> • Ranking V2 • timing-aware</div>",unsafe_allow_html=True)
