...
APP_VERSION = "6.3.9.6"
APP_BUILD_ID = "V6396-DECISION-RANKING-V2-20260922-A"
...
# -----------------------------------------------------------------------------
# V6.3.9.6 Decision Ranking Engine V2
...
def _apply_decision_ranking_v6396(df,scan_mode='Production 151'):
    if df is None or not isinstance(df,pd.DataFrame) or df.empty:return df
    z=df.copy()
...
def _scanner_worker_v599(runtime,job_id,config):
    ...
    try:
        ...
        if isinstance(res,pd.DataFrame) and not res.empty:
            ...
            # V6.3.9.6: final Top-5 / Scanner order uses the transparent
            ...
            res=_apply_decision_ranking_v6396(res,config.get('scan_mode','Production 151'))
