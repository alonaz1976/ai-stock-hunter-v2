...
APP_VERSION = "6.1.8"
APP_BUILD_ID = "V618-TRIGGER-EFFICIENCY-CARRYOVER-AUDIT-20260919-A"
...
st.markdown(f"""<div class='hero'><span class='badge'>V{APP_VERSION} • LIVE ENTRY ACTIONABILITY • TRIGGER EFFICIENCY • CARRYOVER AUDIT</span><div class='hero-title'>📈 AI Stock Hunter<br>V{APP_VERSION}</div><div class='hero-sub'>Adaptive Entry Intelligence • Live Actionability • Causal Trigger Efficiency • Carryover Memory • OOS Evidence</div></div>""",unsafe_allow_html=True)
