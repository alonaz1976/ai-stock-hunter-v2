...
APP_VERSION = "6.2.1"
APP_BUILD_ID = "V621-POST-SPIKE-STRUCTURE-CENSORING-20260919-A"
...
st.markdown(f"""<div class='hero'><span class='badge'>V{APP_VERSION} • POST-SPIKE STRUCTURE • CENSORING AUDIT • NO-OVERFIT GUARD</span><div class='hero-title'>📈 AI Stock Hunter<br>V{APP_VERSION}</div><div class='hero-sub'>Adaptive Entry Intelligence • Session-Aware Post-Spike Structure • Causal Continuation Validation • OOS Evidence</div></div>""",unsafe_allow_html=True)
