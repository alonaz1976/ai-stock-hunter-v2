...
@media (max-width: 700px){
  ...
  .top5-name{font-size:1.12rem}.top5-score{font-size:1.42rem}.top5-opp{font-size:.88rem}
}
    ...
    if res is None or res.empty:
        ...
        for _,r in topcards.iterrows():
            ...
            with st.container(border=True):
                ...
                st.markdown(f"<div class='top5-rankline'><b>TOP {top_score:.1f}</b> • Ranking V2 • timing-aware</div>",unsafe_allow_html=True)
